...
<div style="text-align: center;margin: 50px;">
    <h1 style="color: darkgreen;">Your cart</h1><br><br>
    <?php
      $cart = new cart();
    ...
    <a href="order.php"><button style="background-color: darkgreen;color: azure;padding: 5px;border-radius: 10px;">Book order</button></a>
