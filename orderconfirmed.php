...
$ord=$_SESSION['Order_no'];
$mob=$_SESSION['Mobile'];
mysql_query("insert orders values($ord,$mob)");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class=" bannercover" style="padding:10px 100px; text-align: center; height: 4in;">
    
<div class="orderconfirmed" ><br><br>
<h2><u>Order confirmed!</u></h2><br><b>
<p style="text-align: left; padding-left: 20px">Your order id: <i><?php echo $_SESSION['Order_no'];?></i></p><br>
<p style="text-align: left; padding-left: 20px">Total bill: ₹ <?php echo $_SESSION['totalamt'];?></p><br>
<p style="text-align: left; padding-left: 20px">Mode of payment is <u>cash on delivery only.</u></p><br>
<p style="text-align: left; padding-left: 20px">Delivery within 2-3 working days.</p></b><br>
    <a style="color: azure;" href="index.php">Continue</a>
</div>
</div>
