...
<div class="login" style="border: solid 5px;border-radius: 100px; padding-right: 10px;padding-left: 10px;border-color: darkgreen ; text-align: center; color: darkgreen">
    <h1 >Login to Bettermeds.com</h1><br>
    
    <form style="text-align: center" method="post" action="userverify.php">
        <img src="login.jpg" style="width: 3in; height: 2.5in;border-radius: 60px "><br><br>
        <label for="mobno"><strong>Mobile Number</strong></label>
       <input type="text" name="mobno" id="mobno" required placeholder="Enter Mobile Number Here" style="padding: 8px;border-radius: 40px"><br><br>
        <label for="password" style="padding-left: 0.5in"><strong>Password</strong></label>
        <input type="password" name="password" id="password" placeholder="Enter Password" required style="padding: 8px;border-radius: 40px">
        <br><br><input type="submit" value="Login"  style="width: 1.5in;padding: 10px;font-family:Arial;background-color: darkgreen;color: azure;border-radius: 50px"><br><br>
        New to this Site? Sign Up Here<br>
        <a href="signup.html"><input type="button" value="Sign Up" style="width: 1.5in;padding: 10px;font-family:Arial;background-color: darkgreen;color: azure;border-radius: 50px;"></a>
